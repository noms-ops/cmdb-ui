...
PP.getEditorConfig = function(editor_name, opts)
{
    ...
    else
    {
        ...
        if (!NagUI.models.base.schema.getEntity('enumerator'))
        {
        ...
        if (!NagUI.models.base.schema.getEntity('arraymenu'))
        {
        ...
        if (!NagUI.models.base.schema.getEntity('roles'))
        {
            Ext.define('roles',
            {
                extend: 'Ext.data.Model',
